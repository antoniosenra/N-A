...
//This link describes the value of an XMLHttpRequest: http://www.w3schools.com/xml/dom_httprequest.asp
  ...
  if (document.getElementById("check_breaches").value == "") {
...
//This section describes the error message that's produced if the API returns no results. We can come up with something better than this.
      ...
      document.getElementById("breach_info").innerHTML = "<h4><p>404 - No data returned for  <span class=\"attention\">\"" + email + ".\"</span> This is a good thing! It appears you have no known associated breaches with this account.</p></h4>";
    }
  };
